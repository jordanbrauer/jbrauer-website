      ...
      <div class="off-canvas-wrapper-inner" data-off-canvas-wrapper>
        ...
        <div class="off-canvas position-left reveal-for-large" id="my-info" data-off-canvas data-position="left">
          <div class="row column text-center">
            <br>
            <img class="logo-alt" src="img/logo/jbrauer/svg/jbrauer-alt-logo.svg">
            <h5><small>Web Design &amp; Development</small></h5>
        ...
        <div class="off-canvas-content" data-off-canvas-content>
          <div class="title-bar hide-for-large">
            <img style="position: absolute; left:0; right:0; margin: auto; width: auto; height: 24px;" src="img/logo/jbrauer/png/jbrauer-alt-logo.png">
